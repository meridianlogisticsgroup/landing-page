...
> Plain language summary: We provide Services on an estimate-and-reconcile model. You pay a deposit to book, then the estimate amount before work starts on service day. We reconcile at the end based on actual time, distance, and materials used. There are duties on both sides (access, packing, safe items), and liability is limited unless you buy separate coverage. Please read carefully.
...
3.1 **Deposit to secure date**. A non-refundable deposit (typically CAD $50–$250, as shown at booking) secures your date and goes toward your final bill.

3.2 **Estimate payment before start**. On service day and **before work begins**, you must pay the **estimate amount** shown on your confirmation (less deposit). Accepted methods may include card, Interac e-Transfer, or bank transfer (availability varies by region). If payment is not received, we may delay or refuse service.
...
- Pause the Job during reconciliation; if excessive delays occur or we reasonably suspect non-payment or fraud, we may end the Job and depart. Paused time for our crew is billable if caused by your delay beyond a reasonable grace period.
...
3.6 **Interac e-Transfer and bank transfers**. If you pay via Interac e-Transfer or bank transfer, you authorize verification, fraud checks, and payment confirmations by the payment partner(s). We do not store your full bank credentials.

3.7 **Chargebacks and fees**. If you initiate a chargeback contrary to these Terms and we prevail, you are responsible for our reasonable administrative, attorney, and processing fees, plus any interest permitted by law.

3.8 **Late payment & interest**. Overdue balances may accrue interest at the lesser of 2% per month (24% per annum) or the maximum permitted by law, plus reasonable collection costs.
...
- Parking tickets or bylaw fines arising from building instructions you provided (e.g., no-stopping zones) are your responsibility.
...
5.3 **Rescheduling**. Subject to availability. Fees may apply for last-minute changes (e.g., within 48 hours) or increased scope.
...
7.4 **Pressboard/ready-to-assemble furniture**. Such items (e.g., certain flat-pack brands) are prone to weakness and cosmetic damage when moved. We are not responsible for inherent vice (see Section 9.3).

7.5 **Pianos, safes, oversized items**. Require disclosure and may incur specialty crew/equipment fees or additional lead time.

---

## 8) Photos, Video, and Quality Assurance
8.1 **Operational records**. We may take time-stamped photos or short videos of access points, truck position, item condition, and completed rooms for safety, quality control, and claims handling.

8.2 **Privacy**. We avoid capturing people where practical; incidental capture may occur. We do not publish customer images without consent, except as required for legal/insurance purposes.
...
13.2 **Mediation/arbitration**. If not resolved within 30 days, disputes (other than small claims and applications for injunctive relief) will be resolved by **binding arbitration** in **Toronto, Ontario**, administered by a recognized arbitration body, in English, on an individual basis. Each party bears its own costs absent a contrary award. You and we waive class/collective actions to the extent permitted by law.
...
- **Deposit (non-refundable)** to secure your date (applied to final bill).
- **Estimate amount due before work starts** on service day.
- **Reconciliation at completion** (refund if less; charge if more).
- **High-risk staged billing**: we perform only work pre-paid by estimate(s), pausing to bill a new estimate when the prior one is consumed.
